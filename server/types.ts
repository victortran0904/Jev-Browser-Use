...
export interface Candidate { ref: string; label: string; signature?: string; isText?: boolean; sensitive?: boolean }
export interface FocusedField { ref?: string; signature?: string; label: string; placeholder: string; value: string; isText: boolean }
export interface Observation { documentId?: string; pageContext?: string; metrics?: { domExtractMs?: number; observeMs?: number; mode?: string }; id: string; snapshot: string; candidates: Candidate[]; url: string; title: string; focusedField?: FocusedField; screenshotUrl?: string }
