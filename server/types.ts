...
export interface Observation { id: string; documentId?: string; snapshot: string; candidates: Candidate[]; url: string; title: string; focusedField?: FocusedField; screenshotUrl?: string }
